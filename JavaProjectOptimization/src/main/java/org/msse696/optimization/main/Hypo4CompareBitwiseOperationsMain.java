...
import org.msse696.optimization.compare.Hypo4CompareBitwiseOperations;
...
public class Hypo4CompareBitwiseOperationsMain {
    ...
    private static List<Double> createData(boolean isEfficient, int iterations) {
        Hypo4CompareBitwiseOperations comparator = new Hypo4CompareBitwiseOperations(isEfficient, iterations);
